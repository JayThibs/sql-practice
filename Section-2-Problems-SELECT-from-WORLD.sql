-- SELECT from WORLD Tutorial - Section 2 of SQLZoo.net
...
-- of the continent 'South America'. Divide the population by 
...
SELECT name, capital
 ...
 -- 12. Show the name and the capital where the first letters 
 -- of each match. Don't include countries where the name 
 -- and the capital are the same word.
